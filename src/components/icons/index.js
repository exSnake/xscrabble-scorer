...
export const LucideSend = createIcon("lucide:send");
export const LucideMail = createIcon("lucide:mail");
export const LucideMessageSquare = createIcon("lucide:message-square");
export const LucideCheck = createIcon("lucide:check");
export const LucideAlertCircle = createIcon("lucide:alert-circle");
export const LucideLoader2 = createIcon("lucide:loader-2");
